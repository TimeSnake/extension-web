    ...
    public void onCommand(Sender sender, ExCommand<Sender, Argument> cmd, Arguments<Argument> args) {
        ...
        if ("login".equals(args.getString(0).toLowerCase())) {
            ...
            if (url != null) {
                ...
                link.setText(Network.getChat().getSenderPlugin(Plugin.WEB) + ChatColor.PERSONAL + ChatColor.UNDERLINE + "Click here" + ChatColor.PERSONAL + " to open your personal login link");
                ...
                code.setText(Network.getChat().getSenderPlugin(Plugin.WEB) + ChatColor.PERSONAL + "Code: " + ChatColor.VALUE + url.getCode());
